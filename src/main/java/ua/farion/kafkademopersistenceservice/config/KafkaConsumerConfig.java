package ua.farion.kafkademopersistenceservice.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, PlayerDto> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "persistence-group");
        configProps.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, PlayerDto.class.getName());
